...
export default async function NetWorthPage() {
  ...
  return <main className="mx-auto max-w-4xl px-6 py-10 lg:px-10">
    <div className="mb-10"><p className="label mb-3">Household office · Net worth</p><h1 className="serif text-5xl">Net Worth</h1></div>
