...
export function OntologyView() {
  ...
  return <main className="mx-auto max-w-7xl px-6 py-10 lg:px-10">
    <div className="mb-10 sm:mb-12"><p className="label mb-3">Household office · Taxonomy</p><h1 className="serif text-4xl sm:text-5xl">Ontology</h1><p className="mt-5 max-w-xl text-sm leading-6 text-ink/60">The shared language behind your household finances: what an expense means, where it belongs, and which account carries it.</p></div>
